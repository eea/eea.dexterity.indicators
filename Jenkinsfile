pipeline {
  ...
  environment {
        GIT_NAME = "eea.dexterity.indicators"
        SONARQUBE_TAGS = "demo-www.eea.europa.eu,www.eea.europa.eu-en,www.eea.europa.eu,biodiversity.europa.eu"
    }
          ...
          "Ruff": {
            node(label: 'docker') {
              script {
                ...
                sh '''cp -rf eea.dexterity.indicators/* .'''
                sh '''rm -rf eea.dexterity.indicators'''
